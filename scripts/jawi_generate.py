...
def text_to_image_enhanced(jawi_text, rumi_name, fonts, is_augmented=False):
    ...
    for font_path in fonts:
        try:
            ...
            augmented, aug_info = apply_augmentations_pil(img, bg=bg_color)

            save_image(augmented, rumi_name, jawi_text, font_name=font_name)
            ...
            if is_augmented and ENABLE_AUGMENTATION:
                for aug_idx in range(AUGMENTATIONS_PER_IMAGE):
                    ...
                    augmented, aug_info = apply_augmentations_pil(aug_img, bg=bg_color)
                    
                    save_image(augmented, rumi_name, jawi_text,
                                font_name=font_name,
...
if __name__ == "__main__":
    ...
    for jawi, label in entries:
        text_to_image_enhanced(jawi, label, all_fonts, is_augmented=True)
